        ...
        <div className="portfolio-content">
            ...
            <div className="section-3">
                <div className="section3-content">
                    <p className="content-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et in sed in pellentesque ornare nunc nisl. Augue habitant accumsan, ut parturient orci ac etiam congue mi.</p>
                    <p className="title-desc">Cooking Suggestions</p>
                    <p className="content-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
