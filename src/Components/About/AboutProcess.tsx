            ...
            <div className="pickle-and-bake">
                <div className="bake">
                    <div className="about-bake">
                        ...
                        <p className="about-bake">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet.</p>
                    </div>
                ...
                <div className="pickle">
                    ...
                    <div className="about-pickle">
                        ...
                        <p className="about-pickle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet.</p>
                    </div>
                </div>
            </div>
        </div>
